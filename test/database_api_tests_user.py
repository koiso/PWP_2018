...
class UserDBAPITestCase(unittest.TestCase):
    ...
    def test_modify_user(self):
        ...
        resp = self.connection.modify_user(USER1_NICKNAME 
                                           , MODIFIED_USER1['public_profile']
                                           , MODIFIED_USER1['restricted_profile']
                                          )
    ...
    def test_modify_user_noexistingnickname(self):
        ...
        #Test with an existing user
        resp = self.connection.modify_user(USER_WRONG_NICKNAME
                                           , USER1['public_profile']
                                           , USER1['restricted_profile'])
